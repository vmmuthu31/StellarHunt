...
`}</style>
        ...
        <div className="flex justify-center mt-10 py-10 gap-10 items-center">
          ...
          <div className="text-center  glowing-border  border-x-[0.8px] border-t-[0.2px] p-14 rounded-2xl border-[#C5F404] card1 flex flex-col gap-5 items-center">
        ...
        <div className="flex mt-2 justify-center py-10 gap-10 items-center">
          <div className="text-center glowing-border  w-[330px]  border-x-[0.8px] border-t-[0.2px] p-16 h-[320px]  rounded-2xl border-[#C5F404] card1 flex flex-col gap-5 items-center">
          ...
          <div className="text-center glowing-border w-[330px]  border-x-[0.8px] border-t-[0.2px] p-16 h-[320px]  border-[#C5F404] card1 flex flex-col gap-5 items-center">
          ...
          <div className="text-center glowing-border border-x-[0.8px] border-t-[0.2px] p-16 h-[320px]  rounded-2xl border-[#C5F404] card2 flex flex-col gap-5 items-center">
