...
export const players_data = [
  ...
  },
  {
    ...
    name: "Gyanlaksmi⚔️🔮",
    description:
      "Gyanlakshmi, the enigmatic sage, emanates wisdom and mystic energy, adorned with celestial symbols. ",
    price: 95,
    range: 40,
  },
  {
    ...
    name: "Rohit🥊👊",
    description:
      "Rohit, the versatile artisan, creates masterpieces with a skilled hand and a heart full of passion",
    price: 60,
    range: 95,
  },
  {
    ...
    name: "Nagi🌿🌙",
    description:
      "Nagi, the serene mystic, harnesses the power of nature with a tranquil presence and healing touch. ",
    price: 96,
    range: 20,
  },
  {
    ...
    name: "Thiru🥷🪓",
    description:
      "Thiru, the enigmatic sorcerer, weaves arcane spells with ancient knowledge and a gaze that pierces the ethereal. ",
    price: 100,
    range: 40,
  },
  {
    ...
    name: "Vairam🗡️🌒",
    description:
      "Vairam, the elusive rogue, navigates shadows with a dagger's grace and a mischievous glint in their eye.  ",
    price: 100,
    range: 95,
  },
  {
    ...
    name: "Prashant",
    description:
      "Prashant, the wise scholar, imparts knowledge with a quill in hand and an aura of sagacity. 🐉🕊️",
    price: 87,
    range: 96,
  },
];
